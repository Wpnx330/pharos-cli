...
| W1.4 | B3 doctor --diff | 🟢 SHIPPED (Sep 2, b15d358, review pending) — drift checks vs pharos.lock+canonical baseline; MISSING/MODIFIED(field-level)/EXTRA(INFO); read-only; W1.1 additive JSON; +drift matrix tests; live-binary QA'd (planted drift→MODIFIED args[1]→revert→ok) | app dev | pharos-cli b15d358 |
