...
| W3.2 | A4 pharos try | 🟢 DONE (Sep 4, 24565cd) — internal/mcpclient (JSON-RPC over stdio, zero deps, secret: env interp, timeouts, PG-kill); try cmd: caps summary w/ tool table, exit 1+stderr-tail honesty, exit 2+hint, --json W1.1 purity, --inspect (npx-gated); 17 helper-process tests; win cross-compile green; live e2e QA vs spawned fake server | app dev | pharos-cli 24565cd |
