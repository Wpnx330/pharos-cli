...
var importCmd = &cobra.Command{
	...
	Long: ui.Label.Render("pharos import") + ` reads MCP client configs (Claude Desktop, Cursor, generic)
...
Use --client <id> to import from a specific client only (claude-desktop, cursor, generic).
